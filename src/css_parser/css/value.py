...
class PropertyValue(css_parser.util._NewBase):
    ...
    def __str__(self):
        return "<css_parser.css.%s object length=%r cssText=%r at " "0x%x>" % (
    ...
    cssText = property(
        lambda self: css_parser.ser.do_css_PropertyValue(self),
        _setCssText,
    ...
    value = property(
        lambda self: css_parser.ser.do_css_PropertyValue(self, valuesOnly=True),
        doc="A string representation of the current value "
...
class Value(css_parser.util._NewBase):
    ...
    cssText = property(
        lambda self: css_parser.ser.do_css_Value(self),
        _setCssText,
...
class ColorValue(Value):
    ...
    def __str__(self):
        return (
            "<css_parser.css.%s object type=%s value=%r colorType=%r "
    ...
    def _setCssText(self, cssText):
        ...
        namedcolor = Prod(
            ...
            and (normalize(v) in as_list(self.COLORS.keys())),
            stop=True,
        )
    ...
    cssText = property(
        lambda self: css_parser.ser.do_css_ColorValue(self),
        _setCssText,
        doc="String value of this value.",
    )

    value = property(
        lambda self: css_parser.ser.do_css_CSSFunction(self, True),
...
class DimensionValue(Value):
    ...
    def __str__(self):
        return (
            "<css_parser.css.%s object type=%s value=%r dimension=%r cssText=%r at 0x%x>"
            % (
                self.__class__.__name__,
                self.type,
                self.value,
...
class URIValue(Value):
    ...
    def __str__(self):
        return (
            "<css_parser.css.%s object type=%s value=%r uri=%r cssText=%r at 0x%x>"
            % (
                self.__class__.__name__,
                self.type,
                self.value,
...
class CSSFunction(Value):
    ...
    cssText = property(
        lambda self: css_parser.ser.do_css_CSSFunction(self),
        _setCssText,
        doc="String value of this value.",
    )
...
class MSValue(CSSFunction):
    ...
    cssText = property(
        lambda self: css_parser.ser.do_css_MSValue(self),
        _setCssText,
        doc="String value of this value.",
    )
...
class CSSCalc(CSSFunction):
    ...
    cssText = property(
        lambda self: css_parser.ser.do_css_CSSCalc(self),
        _setCssText,
...
def _ColorProd(parent, nextSor=False, toStore=None):
    return Prod(
        ...
        or (t == "IDENT" and normalize(v) in as_list(ColorValue.COLORS.keys())),
        nextSor=nextSor,
        toStore=toStore,
        toSeq=lambda t, tokens: (
            "ColorValue",
