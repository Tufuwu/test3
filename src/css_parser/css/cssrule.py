...
class CSSRule(css_parser.util.Base2):
    ...
    """
    UNKNOWN_RULE = 0
    ":class:`css_parser.css.CSSUnknownRule` (not used in CSSOM anymore)"
    STYLE_RULE = 1
    ":class:`css_parser.css.CSSStyleRule`"
    CHARSET_RULE = 2
    ":class:`css_parser.css.CSSCharsetRule` (not used in CSSOM anymore)"
    IMPORT_RULE = 3
    ":class:`css_parser.css.CSSImportRule`"
    MEDIA_RULE = 4
    ":class:`css_parser.css.CSSMediaRule`"
    FONT_FACE_RULE = 5
    ":class:`css_parser.css.CSSFontFaceRule`"
    PAGE_RULE = 6
    ":class:`css_parser.css.CSSPageRule`"
    NAMESPACE_RULE = 10
    """:class:`css_parser.css.CSSNamespaceRule`,
    Value has changed in 0.9.7a3 due to a change in the CSSOM spec."""
    COMMENT = 1001  # was -1, css_parser only
    """:class:`css_parser.css.CSSComment` - not in the offical spec,
    Value has changed in 0.9.7a3"""
    VARIABLES_RULE = 1008
    """:class:`css_parser.css.CSSVariablesRule` - experimental rule
