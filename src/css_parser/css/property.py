...
class Property(css_parser.util.Base):
    """A CSS property in a StyleDeclaration of a CSSStyleRule (css_parser).
    ...
    def __repr__(self):
        return "css_parser.css.%s(name=%r, value=%r, priority=%r)" % (
    ...
    def _getCssText(self):
        ...
        return css_parser.ser.do_Property(self)
    ...
    def validate(self):
        ...
        try:
            ...
            if rule is not None:
                if rule.type == rule.FONT_FACE_RULE:
                    profiles = [css_parser.profile.CSS3_FONT_FACE]
                # TODO: same for @page
        ...
        if self.name and self.value:
            ...
            #     css_parser.log.warn(u'No value for variable "%s" found, keeping '
